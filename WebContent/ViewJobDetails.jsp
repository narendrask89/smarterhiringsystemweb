...
String compuser=(String)context.getAttribute("comp_user");
%>
...
-->
      ...
      try
    	  ...
    	  String compId=(String)context.getAttribute("comp_user");
    	  
      Statement st=con.createStatement();
      ResultSet rs=st.executeQuery("select * from JobDetails where comp_Id='"+compId+"'");
